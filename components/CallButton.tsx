  ...
  return (
    <div className="fixed z-50 bottom-6 right-6 md:bottom-8 md:right-8">
      <a
        ...
        className="inline-flex items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-full shadow-lg bg-gradient-to-br from-[#f59e0b] to-[#d97706] text-white hover:scale-105 transition-transform ring-1 ring-black/10"
      >
        <svg
